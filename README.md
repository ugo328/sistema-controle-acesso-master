A aplicação de  Condomínio em sua primeira versão  foi desenvolvida para solucionar problemas de gestão de um condomínio, sendo uma iniciativa totalmente original e gratuita, para a primeira versão.
 Esse Sistema 
